 ...
 *
 *  URL https://www.google.com/search tersebut ditambahkanlah query berikut:        // endpoint search
 *
 *                  q=Indonesia
 *
...
// modul url untuk mengekstract query pada url -> q=Indonesia
const url = require("url");

// modul querystring untuk membuat object dari query yang di url -> object dari q=Indonesia {"q" : "Indonesia"}
...
const server = http.createServer((req, res) => {
   ...
   * localhost:3000/?search=Belajar+Javascript
